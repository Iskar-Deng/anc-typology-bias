...
# evaluation/pairs_building/phenomena/1_9_intran_V_valency/rules.py

"""
Define perturbation rules for 1.9 Intransitive V valency.

Usage:
python -m evaluation.pairs_building.apply_perturbation \
  --phenomenon evaluation/pairs_building/phenomena/1_9_intran_V_valency \
...
def perturb(
    ...
    return {
        ...
        "perturbation": "replace_intransitive_verb_with_transitive_valency_foil",
    }
