...
# evaluation/pairs_building/phenomena/3_3_clausal_A_marker/rules.py

"""
Define perturbation rules for 3.3 Clausal complement A marker.

Usage:
python -m evaluation.pairs_building.apply_perturbation \
  --phenomenon evaluation/pairs_building/phenomena/3_3_clausal_A_marker \
...
def perturb(
    ...
    return {
        ...
        "embedded_a_span": target_np.text,
